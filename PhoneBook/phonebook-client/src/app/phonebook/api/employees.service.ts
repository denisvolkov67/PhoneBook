...
export class EmployeesService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public employeesEditEmployee(body: UpdateEmployeeCommand, observe?: 'body', reportProgress?: boolean): Observable<Employee>;
    public employeesEditEmployee(body: UpdateEmployeeCommand, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Employee>>;
    public employeesEditEmployee(body: UpdateEmployeeCommand, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Employee>>;
    public employeesEditEmployee(body: UpdateEmployeeCommand, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Employee>('put',`${this.basePath}/employee`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
